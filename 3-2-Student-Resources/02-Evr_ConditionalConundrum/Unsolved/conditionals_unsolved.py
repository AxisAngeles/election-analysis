...
if 2 * x > 10:
    ...
    print("oooo needs some work")#Result
...
if name in group_one:
    ...
    print(name + " is in group three")#Results
else:
...
if (height > 70) and (age >= 18):
    ...
    print("Can ride bumper cars")#Results
else:
